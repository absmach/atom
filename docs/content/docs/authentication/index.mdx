...
<Cards>
  ...
  <Card title="Certificates" href="/authentication/certificates" description="Managed authorities, mTLS certificate issuance, trust distribution, CRL, OCSP, and runtime lookup." />
