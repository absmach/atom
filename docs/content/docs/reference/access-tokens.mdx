...
description: Detailed behavior and security rules for scoped access tokens.
---
...
This document defines self-service scoped access tokens. The source of truth for overall product requirements is [Product Requirements](./product-requirements), and authorization terminology is defined in the [Access Model](./access-model).
