...
description: Atom's product scope, behavior, and public API requirements.
---
...
Detailed endpoint behavior is maintained in the published query documentation:

1. [Authorization explain](../queries/authz-explain)
2. [Entity access](../queries/entity-access)
3. [Resource access](../queries/resource-access)
4. [Audit](../queries/audit)
5. [Bulk authorization check](../queries/bulk-check)
6. [Role holders](../queries/role-holders)
7. [Principal Group access](../queries/group-access)
8. [Effective actions](../queries/effective-actions)
9. [Admin hygiene](../queries/admin-hygiene)
10. [Magistrala integration](../magistrala-on-atom)
11. [Access model](./access-model)
12. [Certificate lifecycle](./certificate-lifecycle)
13. [Scoped access tokens](./access-tokens)
14. [GraphQL error contract](https://github.com/absmach/atom/blob/main/api/v1/graphql-error-contract.md) — stable `extensions.code`/`retryable`/`requestId` on every GraphQL error, and the `X-Request-ID` response header (issue #101)
...
- [Repository README](https://github.com/absmach/atom#readme)
- [Access model](./access-model)
- [OpenAPI spec](https://github.com/absmach/atom/blob/main/apidocs/openapi.yaml)
- [gRPC reference](https://github.com/absmach/atom/blob/main/apidocs/grpc-reference.md)
- [Magistrala integration](../magistrala-on-atom)
