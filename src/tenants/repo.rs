...
fn tenant_order_by(order: TenantOrderField, dir: SortDir) -> &'static str {
    match (order, dir) {
        ...
        (TenantOrderField::UpdatedAt, SortDir::Desc) => "updated_at DESC, id ASC",
        (TenantOrderField::Name, SortDir::Asc) => "name ASC, id ASC",
        (TenantOrderField::Name, SortDir::Desc) => "name DESC, id ASC",
        (TenantOrderField::Alias, SortDir::Asc) => "alias ASC, id ASC",
        (TenantOrderField::Alias, SortDir::Desc) => "alias DESC, id ASC",
...
fn tenant_order_by_alias(order: TenantOrderField, dir: SortDir) -> &'static str {
    match (order, dir) {
        ...
        (TenantOrderField::UpdatedAt, SortDir::Desc) => "t.updated_at DESC, t.id ASC",
        (TenantOrderField::Name, SortDir::Asc) => "t.name ASC, t.id ASC",
        (TenantOrderField::Name, SortDir::Desc) => "t.name DESC, t.id ASC",
        (TenantOrderField::Alias, SortDir::Asc) => "t.alias ASC, t.id ASC",
        (TenantOrderField::Alias, SortDir::Desc) => "t.alias DESC, t.id ASC",
