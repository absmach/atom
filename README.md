...
| `ATOM_PKI_ENROLLMENT_HTTP_HEADER_TIMEOUT_SECS` / `ATOM_PKI_ENROLLMENT_REQUEST_BODY_TIMEOUT_SECS`                             | `10` / `30`                                          | Bound slow HTTP header and request-body uploads before enrollment authentication        |
