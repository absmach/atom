...
export const crudResources: CrudResource[] = [
  ...
  },
  {
    ...
    queryName: "roles",
    tenantFilter: true,
    listQuery: `query Roles($tenantId: ID, $derivedKind: String, $deleted: DeletedFilter, $limit: Int = 50, $offset: Int = 0) { roles(tenantId: $tenantId, derivedKind: $derivedKind, deleted: $deleted, limit: $limit, offset: $offset) { total items { id name tenantId description derivedKind deletedAt deletedBy createdAt updatedAt } } }`,
