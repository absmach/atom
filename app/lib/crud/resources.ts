...
export const crudResources: CrudResource[] = [
  ...
  },
  {
    ...
    queryName: "groups",
    tenantFilter: true,
    listQuery: `query Groups($tenantId: ID, $status: EntityStatus, $deleted: DeletedFilter, $limit: Int = 50, $offset: Int = 0) { groups(tenantId: $tenantId, status: $status, deleted: $deleted, limit: $limit, offset: $offset) { total items { id name tenantId groupType parentId description status deletedAt deletedBy createdAt updatedAt } } }`,
  ...
  },
  {
    ...
    queryName: "roles",
    tenantFilter: true,
    listQuery: `query Roles($tenantId: ID, $deleted: DeletedFilter, $limit: Int = 50, $offset: Int = 0) { roles(tenantId: $tenantId, deleted: $deleted, limit: $limit, offset: $offset) { total items { id name tenantId description attributes derivedKind deletedAt deletedBy createdAt updatedAt } } }`,
    createMutation: `mutation CreateRole($input: CreateRoleInput!) { createRole(input: $input) { id name tenantId description attributes derivedKind createdAt updatedAt } }`,
