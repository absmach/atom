...
export const crudResources: CrudResource[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "subjectKind", label: "Subject", priority: "high" },
      { key: "grantKind", label: "Grant", priority: "medium" },
      { key: "scopeKind", label: "Scope", priority: "high" },
      { key: "createdAt", label: "Created", priority: "low" },
    ],
    sampleRows: [
      {
    ...
    missing: { update: "Policy updates are not available yet." },
  },
];
