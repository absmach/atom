...
export const crudResources: CrudResource[] = [
  ...
  },
  {
    ...
    queryName: "resources",
    tenantFilter: true,
    listQuery: `query Resources($tenantId: ID, $kind: String, $deleted: DeletedFilter, $limit: Int = 50, $offset: Int = 0) { resources(tenantId: $tenantId, kind: $kind, deleted: $deleted, limit: $limit, offset: $offset) { total items { id kind name alias tenantId ownerId objectGroupIds attributes deletedAt deletedBy createdAt updatedAt } } }`,
