...
export const crudResources: CrudResource[] = [
  {
    ...
    icon: Building2,
    queryName: "tenants",
    listQuery: `query Tenants($deleted: DeletedFilter, $limit: Int = 50, $offset: Int = 0) { tenants(deleted: $deleted, limit: $limit, offset: $offset) { total items { id name alias tags attributes status deletedAt deletedBy createdAt updatedAt managedBy } } }`,
  ...
  },
  {
    ...
    queryName: "groups",
    tenantFilter: true,
    listQuery: `query Groups($tenantId: ID, $status: EntityStatus, $deleted: DeletedFilter, $limit: Int = 50, $offset: Int = 0) { groups(tenantId: $tenantId, status: $status, deleted: $deleted, limit: $limit, offset: $offset) { total items { id name tenantId groupType parentId description status deletedAt deletedBy createdAt updatedAt managedBy } } }`,
  ...
  },
  {
    ...
    queryName: "resources",
    tenantFilter: true,
    listQuery: `query Resources($tenantId: ID, $kind: String, $deleted: DeletedFilter, $limit: Int = 50, $offset: Int = 0) { resources(tenantId: $tenantId, kind: $kind, deleted: $deleted, limit: $limit, offset: $offset) { total items { id kind name alias tenantId ownerId parentGroupId attributes deletedAt deletedBy createdAt updatedAt managedBy } } }`,
  ...
  },
  {
    ...
    queryName: "roles",
    tenantFilter: true,
    listQuery: `query Roles($tenantId: ID, $derivedKind: String, $deleted: DeletedFilter, $limit: Int = 50, $offset: Int = 0) { roles(tenantId: $tenantId, derivedKind: $derivedKind, deleted: $deleted, limit: $limit, offset: $offset) { total items { id name tenantId description derivedKind deletedAt deletedBy createdAt updatedAt managedBy } } }`,
